...
demo.state3.prototype = {
    preload: function (){
        game.load.image('button1', 'assets/sprites/MagicButtonBlue.png')
        game.load.image('button2', 'assets/sprites/MagicButtonRed.png')
        game.load.image('button3', 'assets/sprites/MagicButtonYellow.png')
        game.load.audio('pops', 'assets/sounds/echoWhoosh.wav')
    },
    create: function(){
